...
export function Awards() {
  return (
    <section className="relative w-full overflow-hidden bg-[#001b3d] py-24 sm:py-32">
      ...
      <div className="absolute top-1/2 right-0 h-[600px] w-[600px] -translate-y-1/2 rounded-full bg-[#004ab0]/40 blur-[140px] animate-pulse delay-1000" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <div className="text-center mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 rounded-full bg-white/5 border border-white/10 px-4 py-1.5 text-xs font-bold text-white/60 uppercase tracking-[0.3em] mb-6"
          >
          ...
          <motion.h2
            ...
            className="text-4xl font-black leading-tight text-white sm:text-6xl uppercase tracking-tighter"
          >
        ...
        {/* High-Performance Infinite Marquee */}
        <div className="relative mt-10 flex overflow-hidden py-12 before:absolute before:left-0 before:top-0 before:z-20 before:h-full before:w-40 before:bg-gradient-to-r before:from-[#001b3d] before:to-transparent after:absolute after:right-0 after:top-0 after:z-20 after:h-full after:w-40 after:bg-gradient-to-l after:from-[#001b3d] after:to-transparent">
          <motion.div 
            animate={{ x: ["0%", "-50%"] }}
          ...
          >
            {[...companies, ...companies].map((company, i) => (
              ...
              >
                {/* Premium White Card */}
                <div className="relative h-24 w-48 sm:h-28 sm:w-56 flex items-center justify-center rounded-[2rem] bg-white border border-white/20 shadow-[0_15px_35px_-10px_rgba(0,0,0,0.2)] transition-all duration-500 group-hover:scale-105 group-hover:shadow-[0_25px_60px_-15px_rgba(192,255,51,0.2)] overflow-hidden">
                  ...
                  <img 
                    src={company.img} 
                    alt={company.name}
                    className="h-14 w-auto max-w-[90%] object-contain relative z-10 transition-transform duration-500 group-hover:scale-110"
                  />
                </div>
